...
import com.lingona.cd4j.api.ConflictHandler;
...
public class ConflictDetector implements IDetectConflicts {
    ...
    public <TUncommitted, TCommitted> void register(ConflictHandler handler) { //where TUncommitted : class where TCommitted : class
