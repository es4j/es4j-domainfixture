...
public abstract class AggregateBase<TEvent> implements IAggregate, IEquatable<IAggregate> {

    private final Collection<Object> uncommittedEvents = new LinkedList<Object>();
    private IRouteEvents registeredRoutes;
    protected UUID id;       // { get; protected set; }
    ...
    protected <TEvent> void register(EventHandlerDelegate<TEvent> route) {
    ...
    /*
     * protected IMemento getSnapshot() { // virtual return null; }
     */
